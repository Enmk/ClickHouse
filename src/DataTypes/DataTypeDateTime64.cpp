...
static inline void readText(DateTime64 & x, UInt32 scale, ReadBuffer & istr, const FormatSettings & settings, const TimeZoneImpl & time_zone, const TimeZoneImpl & utc_time_zone)
{
